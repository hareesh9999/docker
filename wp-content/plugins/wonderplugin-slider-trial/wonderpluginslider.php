<?php
/*
Plugin Name: Wonder Slider Trial
...
define('WONDERPLUGIN_SLIDER_VERSION', '12.9');
...
define('WONDERPLUGIN_SLIDER_PLUGIN_VERSION', '12.9');
...
class WonderPlugin_Slider_Plugin {
	...
	function register_menu()
	{
		...
		$menu = add_menu_page(
				__('Wonder Slider Trial', 'wonderplugin_slider'),
				__('Wonder Slider Trial', 'wonderplugin_slider'),
				$userrole,
 ...
 * Uninstallation
 */
if ( !function_exists('wonderplugin_slider_uninstall') )
{
